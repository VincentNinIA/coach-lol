# Mapping ID de champion -> Nom de champion
# Source: Data Dragon API Riot
# Liste partielle des champions les plus populaires
...
def get_champion_name(champion_id):
    """Retourne le nom du champion depuis son ID, ou l'ID si inconnu"""
    ...
    return CHAMPION_NAMES.get(champion_id, f"ChampID:{champion_id}")
